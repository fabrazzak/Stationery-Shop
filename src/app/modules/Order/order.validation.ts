...
export const orderValidation = z.object({
  ...
  quantity: z.number().int().positive("Quantity must be a positive integer").nonnegative("Quantity must be a non-negative integer"), // Validates quantity as a positive integer
